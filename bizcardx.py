...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Srinivasan M",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Srinivasan M*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://wallpapers.com/images/high/plain-background-31p9u4k4k7hq5s2g.webp");
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        # Converting Image to Binary and Upload to SQL database
